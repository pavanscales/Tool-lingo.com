...
const Index = () => {
  ...
  const tools = [
    {
      name: "Creatr",
      description: "Create & deploy web apps in seconds",
      icon: "Cr",
      iconBg: "bg-black",
    ...
    {
      name: "NOS Agent",
      description: "Go-To-Market AI agent for lead generation",
      icon: "NOS",
      iconBg: "bg-white",
    ...
    {
      name: "Saaspo",
      description: "SaaS design inspiration library",
      icon: "[]",
      iconBg: "bg-black",
      iconColor: "text-white",
      category: "Design"
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-gray-200">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div>
            <Button variant="default" className="bg-black text-white hover:bg-gray-800">Submit a tool</Button>
          </div>
        </div>
      </header>
      ...
      <section className="py-8 container mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-12">
          {categories.map((category) => (
            <Badge 
              key={category.name}
              className={`${category.color} hover:${category.color} text-gray-800 rounded-full px-4 py-2 cursor-pointer`}
              variant="outline"
            >
              {category.name}
            </Badge>
